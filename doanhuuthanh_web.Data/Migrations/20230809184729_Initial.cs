        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Statuscs = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TransacionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeDescription", "This is description of doanhuuthanh_web" },
                    { "HomeKeyword", "This is keyword of doanhuuthanh_web" },
                    { "HomeTitle", "This is home page of doanhuuthanh_web" }
                });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "Id", "IsShowOnHome", "SortOder", "Status", "parentId" },
                values: new object[,]
                {
                    { 1, true, 1, 1, null },
                    { 2, true, 2, 1, null }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 8, 10, 1, 47, 29, 196, DateTimeKind.Local).AddTicks(8068), 1000000m, 200000m, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi-VN", "Áo nữ", "ao-nu", "Sản phẩm thời trang nu", "Sản phẩm thời trang nu" },
                    { 2, 1, "en-US", "Women Shirt", "women-shirt", "The shirt products for women", "The shirt products for women" },
                    { 3, 2, "vi-VN", "Áo nam", "ao-nam", "Sản phẩm thời trang nam", "Sản phẩm thời trang nam" },
                    { 4, 2, "en-US", "Men Shirt", "men-shirt", "The shirt products for man", "The shirt products for man" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Áo sơ mi nam trắng", "Mô tả sản phẩm", "vi-VN", "Áo sơ mi nam trắng", 1, "ao-so-mi-nam-trang", "Áo sơ mi nam trắng", "Áo sơ mi nam trắng" },
                    { 2, "Men T-shirt", "Mô tả sản phẩm", "en-US", "Men T-shirt", 1, "men-t-shirt", "Men T-shirt", "Men T-shirt" }
                });
